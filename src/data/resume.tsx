...
export const DATA = {
  ...
  description:
    "I’m a Blockchain Developer and Security Researcher with experience building secure DeFi systems, including work on a project for the US-based company Abra. I’ve contributed to DeFi, NFT marketplaces, GameFi, and supply chain projects, implementing ERC-20, ERC-721, and upgradeable proxy patterns (EIP-1167) across EVM and Solana ecosystems.sI specialize in Solidity, Rust, and Anchor, with strong expertise in smart contract development, testing, auditing, gas optimization, Layer 2 scaling, and protocol design. My work includes secure deployments using Hardhat and Foundry, as well as an accepted Medium-severity audit finding.",
  summary:
    "I’m a Blockchain Developer and Security Researcher with experience building secure DeFi systems, including work on a project for the US-based company Abra. I’ve contributed to DeFi, NFT marketplaces, GameFi, and supply chain projects, implementing ERC-20, ERC-721, and upgradeable proxy patterns (EIP-1167) across EVM and Solana ecosystems. specialize in Solidity, Rust, and Anchor, with strong expertise in smart contract development, testing, auditing, gas optimization, Layer 2 scaling, and protocol design. My work includes secure deployments using Hardhat and Foundry, as well as an accepted Medium-severity audit finding.",
