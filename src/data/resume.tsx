...
export const DATA = {
  ...
  description:
    "Blockchain Developer with hands-on experience delivering production-grade DeFi and infrastructure solutions, having worked on more than 5 live blockchain projects, including 2 large-scale international projects in DeFi and supply chain for clients in the USA and Thailand. I have proven experience in full-stack development, building secure smart contracts along with supporting backend infrastructure and integrations. I am highly focused on writing optimized, secure, and production-ready blockchain systems. Passionate about zero-knowledge proofs, blockchain infrastructure, protocol development and HFT.",
  summary:
    "Blockchain Developer with hands-on experience delivering production-grade DeFi and infrastructure solutions, having worked on more than 5 live blockchain projects, including 2 large-scale international projects in DeFi and supply chain for clients in the USA and Thailand. I have proven experience in full-stack development, building secure smart contracts along with supporting backend infrastructure and integrations. I am highly focused on writing optimized, secure, and production-ready blockchain systems. Passionate about zero-knowledge proofs, blockchain infrastructure, protocol development and HFT.",
